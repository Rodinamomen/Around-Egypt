...
import com.example.aroundegypt.features.home.domain.models.Data

class RecommendedAdapter(private val experiencesList: List<Data>,private val context: Context,private val recommendedVisibility:Boolean):RecyclerView.Adapter<RecommendedAdapter.RecommendedHolder>() {
    ...
    fun setOnClickListener(listener: OnItemClickListener) {
        ...
        val row = LayoutInflater.from(parent.context).inflate(R.layout.experience_item,parent, false)
